...
<acme:form>
	...
	<acme:form-integer  code="authenticated.offer.form.label.salaryBottom"   path="salaryBottom"/>
	<acme:form-integer  code="authenticated.offer.form.label.salaryTop"   path="salaryTop"/>
